...
def main():
		...
		# make a terrain
		terrain = ode.Terrain(world, space=space)
		...
		terrain.set_material_layer(material1, 0.0, 0.6)
		terrain.set_material_layer(material2, 0.6, 0.8)
		terrain.texture_factor = 1.0
		terrain.scale_factor   = 1.0
		terrain.split_factor   = 2.0
		terrain.x = -4.0
		terrain.z = -4.0
		#print terrain.__dict__
		...
		main_loop = MainLoop(world)
		main_loop.round_duration = dt
		main_loop.main_loop()
